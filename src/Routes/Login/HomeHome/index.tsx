  ...
  <Container>
    ...
    <body>
      <p>
        ...
        (plusbeauxjours)(‘pinner.fun’이하 ‘pinner’) 은(는) 다음의 목적을 위하여
        ...
        <br />
        <br />
        ①(plusbeauxjours)(‘pinner.fun’이하 ‘pinner’) 은(는) 정보주체로부터
      ...
      <p>
        ① 정보주체는 plusbeauxjours(‘pinner.fun’이하 ‘pinner) 에 대해 언제든지
      ...
      <p>
        ...
        <br />
        <br /> ① <em>(plusbeauxjours)('pinner.fun'이하 'pinner')</em>은(는)
        다음의 개인정보 항목을 처리하고 있습니다.
      </p>
      <p>
        1(위탁)
        <br />- 필수항목 : 이메일, 휴대전화번호, 접속 로그, 쿠키
        <br />- 선택항목 : 이메일, 휴대전화번호, 성별, 이름, 서비스 이용 기록,
        접속 로그, 쿠키, 접속 IP 정보
      </p>
      <br />
      <br />
      ...
      <p>
        <strong>
          5. 개인정보의 파기<em>(plusbeauxjours)('pinner')</em>은(는) 원칙적으로
      ...
      <p>
        ① plusbeauxjours 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를
        ...
        거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을
        통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형
        ...
        <br /> ① plusbeauxjours(‘pinner.fun’이하 ‘pinner) 은(는) 개인정보 처리에
        ...
        <p>
          ...
          직급 :대표
          <br />
          연락처 :01085201031, pinner.superuser@gmail.com, 01085201031
          <br />※ 개인정보 보호 담당부서로 연결됩니다.
          <br /> <br />▶ 개인정보 보호 담당부서
          <br />
          부서명 :<br />
          담당자 :<br />
          연락처 :, , <br />② 정보주체께서는 plusbeauxjours(‘pinner.fun’이하
          ‘pinner) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호
          관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및
          담당부서로 문의하실 수 있습니다. plusbeauxjours(‘pinner.fun’이하
          ‘pinner) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
          것입니다.
        </p>
        <br />
        <br />
        ...
        <p>
          <strong>
            9. 개인정보의 안전성 확보 조치 <em>(plusbeauxjours)('pinner')</em>
        ...
        <p>
          ...
          <br />
          4. 해킹 등에 대비한 기술적 대책
          <br /> <em>plusbeauxjours</em>>('<em>pinner</em>')은 해킹이나 컴퓨터
          바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을
